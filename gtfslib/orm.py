...
class _Orm(object):
    ...
    def __init__(self, engine, schema=None):
        ...
        _transfer_mapper = Table('transfers', self._metadata,
                                 ...
                                 _transfer_from_trip_id_column,
                                 _transfer_to_trip_id_column,
                                 ...
                                 ForeignKeyConstraint(['feed_id', 'from_trip_id'], ['trips.feed_id', 'trips.trip_id']),
                                 ForeignKeyConstraint(['feed_id', 'to_trip_id'], ['trips.feed_id', 'trips.trip_id']),
                                 Index('idx_transfer_from_stop', 'feed_id', 'from_stop_id'),
                                 Index('idx_transfer_to_stop', 'feed_id', 'to_stop_id'),
                                 Index('idx_transfer_from_trip', 'feed_id', 'from_trip_id'),
                                 Index('idx_transfer_to_trip', 'feed_id', 'to_trip_id'))
